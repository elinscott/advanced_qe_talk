...
\begin{frame}{Take home messages}
   ...
   \vspace{1em}
   Koopmans can be used to replace GW when calculating neutral excitations with BSE

   \vspace{1em}
   We have recently released \texttt{koopmans}, a package that contains everything necessary to run calculations using Koopmans functionals without expert knowledge
...
\begin{frame}{Koopmans functionals: theory}
   ...
   \begin{overlayarea}{\textwidth}{0.5\paperheight}
      ...
      \only<5->{
         ...
         \begin{itemize}
            \item<6-> screening
            \item<7-> orbital-density dependence
         \end{itemize}
      }
      \only<7>{
         \begin{equation*}
...
\begin{frame}{Take home messages}
   ...
   \begin{itemize}
      ...
      \item Koopmans can replace GW when calculating neutral excitations with BSE
   \end{itemize}
...
\begin{frame}{Acknowledgements}
   ...
   \begin{center}
      ...
      Free online school Nov 9-11 2022 \emph{Advanced Quantum ESPRESSO tutorial: Hubbard and Koopmans functionals from linear response}. Too late to register but it will be recorded!
      \vspace{1em}
