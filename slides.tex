...
\setbeamertemplate{title page}
{
  ...
  \begin{center} 
  \LARGE
  \textbf{Accurate charged and neutral excitations \\ with Koopmans functionals}
  \end{center}
  \end{minipage}
  \end{tcolorbox}
  ...
  \begin{center}
  \footnotesize \bf \insertauthor\quad | \quad\insertshortinstitute\quad | \quad9th TDDFT Workshop, Benasque\quad|\quad \insertdate    
  \end{center}
  %  \end{flushright}
  \end{tcolorbox}
  }
...
\begin{frame}{Koopmans functionals: theory}
   ...
   \begin{itemize}
      ...
      \item Dielectric-dependent hybrid functionals of Galli and co-workers \cite{Skone2016}
